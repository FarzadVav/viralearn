  ...
  return (
    <>
      <div className="container mt-6">
        <div className="card glassy-card grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2">
            <h1 className="heading max-lg:text-center">برنامه نویسی وب</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mt-3">
              ...
              <Input
                ...
                dir="ltr"
              />
              <div className="max-lg:col-span-2 f-align gap-3">
                <Input
                  className="w-max"
                  id="file"
                  type="file"
            ...
            <div className="f-align justify-end mt-3">
              <Button>ارسال</Button>
            </div>
          </div>
          <Image
